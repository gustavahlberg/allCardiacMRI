...
genCorVol = genCor[c("ilamax","ilamin","lamax","lamin")]

table = do.call(rbind, genCorVol)
...
idx = sapply(seq(0,length.out = 10, by = 5) ,function(i) (1:4 + i))
...
tiff(filename = "LaVol_GeneticCorrelation_200515.tiff",
     width = 9, height = 8.5, 
     units = 'in',
     res = 300)
