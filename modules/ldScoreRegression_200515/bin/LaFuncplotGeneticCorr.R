...
genCorFunc = genCor[c("laaef","lapef","latef")]

table = do.call(rbind, genCorFunc)
...
idx = sapply(seq(0,length.out = 10, by = 4) ,function(i) (1:3 + i))
...
tiff(filename = "LaFunc_GeneticCorrelation_200515.tiff",
     width = 9, height = 8.5, 
     units = 'in',
     res = 300)
