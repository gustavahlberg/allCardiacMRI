...
samplesCMR <- as.character(allTab$IID)
...
dateICD10 = dateICD10[samplesCMR,]
...
externalCauses_datacoding19 = externalCauses_datacoding19[samplesCMR,]
...
dateOPCS4 = dateOPCS4[samplesCMR,]
...
illnessSelfreported = illnessSelfreported[samplesCMR,]
...
opCodeSelfReported = opCodeSelfReported[samplesCMR,]
