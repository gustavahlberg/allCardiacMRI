...
mtCojoListVol = split(mtCojoTabVol, mtCojoTabVol$SNP)

lenRsids = do.call(rbind,(lapply(mtCojoListVol, dim)))[,1]
...
tiff(filename = "LAvol_conditionalAnalysis.tiff",
     width = 9, height = 8.5, 
     units = 'in',
     res = 300)
